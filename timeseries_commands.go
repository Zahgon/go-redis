...
func (cmd *TSNRangePivotRowSliceCmd) String() string { _ = "STUB: not implemented"; return "" }
...
func (cmd *TSNRangePivotRowSliceCmd) Clone() Cmder { _ = "STUB: not implemented"; return *new(Cmder) }
